...
const heroes = [
    { name: 'Aamon', img: 'mlbbdraftobs/Assets/HeroPick/aamon.png' },
    { name: 'Akai', img: 'mlbbdraftobs/Assets/HeroPick/akai.png' },
    { name: 'Aldous', img: 'mlbbdraftobs/Assets/HeroPick/aldous.png' },
    { name: 'Alice', img: 'mlbbdraftobs/Assets/HeroPick/alice.png' },
    { name: 'Alpha', img: 'mlbbdraftobs/Assets/HeroPick/alpha.png' },
    { name: 'Alucard', img: 'mlbbdraftobs/Assets/HeroPick/alucard.png' },
    { name: 'Angela', img: 'mlbbdraftobs/Assets/HeroPick/angela.png' },
    { name: 'Argus', img: 'mlbbdraftobs/Assets/HeroPick/argus.png' },
    { name: 'Atlas', img: 'mlbbdraftobs/Assets/HeroPick/atlas.png' },
    { name: 'Aulus', img: 'mlbbdraftobs/Assets/HeroPick/aulus.png' },
    { name: 'Aurora', img: 'mlbbdraftobs/Assets/HeroPick/aurora.png' },
    { name: 'Badang', img: 'mlbbdraftobs/Assets/HeroPick/badang.png' },
    { name: 'Balmond', img: 'mlbbdraftobs/Assets/HeroPick/balmond.png' },
    { name: 'Bane', img: 'mlbbdraftobs/Assets/HeroPick/bane.png' },
    { name: 'Barats', img: 'mlbbdraftobs/Assets/HeroPick/barats.png' },
    { name: 'Baxia', img: 'mlbbdraftobs/Assets/HeroPick/baxia.png' },
    { name: 'Beatrix', img: 'mlbbdraftobs/Assets/HeroPick/beatrix.png' },
    { name: 'Beleric', img: 'mlbbdraftobs/Assets/HeroPick/beleric.png' },
    { name: 'Benedetta', img: 'mlbbdraftobs/Assets/HeroPick/benedetta.png' },
    { name: 'Brody', img: 'mlbbdraftobs/Assets/HeroPick/brody.png' },
    { name: 'Bruno', img: 'mlbbdraftobs/Assets/HeroPick/bruno.png' },
    { name: 'Carmila', img: 'mlbbdraftobs/Assets/HeroPick/carmila.png' },
    { name: 'Cecilion', img: 'mlbbdraftobs/Assets/HeroPick/cecilion.png' },
    { name: 'Chang\'e', img: 'mlbbdraftobs/Assets/HeroPick/chang_e.png' },
    { name: 'Chip', img: 'mlbbdraftobs/Assets/HeroPick/chip.png' },
    { name: 'Chou', img: 'mlbbdraftobs/Assets/HeroPick/chou.png' },
    { name: 'Cici', img: 'mlbbdraftobs/Assets/HeroPick/cici.png' },
    { name: 'Claude', img: 'mlbbdraftobs/Assets/HeroPick/claude.png' },
    { name: 'Clint', img: 'mlbbdraftobs/Assets/HeroPick/clint.png' },
    { name: 'Cyclops', img: 'mlbbdraftobs/Assets/HeroPick/cyclops.png' },
    { name: 'Diggie', img: 'mlbbdraftobs/Assets/HeroPick/diggie.png' },
    { name: 'Dyroth', img: 'mlbbdraftobs/Assets/HeroPick/dyroth.png' },
    { name: 'Edith', img: 'mlbbdraftobs/Assets/HeroPick/edith.png' },
    { name: 'Esmeralda', img: 'mlbbdraftobs/Assets/HeroPick/esmeralda.png' },
    { name: 'Estes', img: 'mlbbdraftobs/Assets/HeroPick/estes.png' },
    { name: 'Eudora', img: 'mlbbdraftobs/Assets/HeroPick/eudora.png' },
    { name: 'Fanny', img: 'mlbbdraftobs/Assets/HeroPick/fanny.png' },
    { name: 'Faramis', img: 'mlbbdraftobs/Assets/HeroPick/faramis.png' },
    { name: 'Floryn', img: 'mlbbdraftobs/Assets/HeroPick/floryn.png' },
    { name: 'Franco', img: 'mlbbdraftobs/Assets/HeroPick/franco.png' },
    { name: 'Fredrin', img: 'mlbbdraftobs/Assets/HeroPick/fredrin.png' },
    { name: 'Freya', img: 'mlbbdraftobs/Assets/HeroPick/freya.png' },
    { name: 'Gatotkaca', img: 'mlbbdraftobs/Assets/HeroPick/gatotkaca.png' },
    { name: 'Gloo', img: 'mlbbdraftobs/Assets/HeroPick/gloo.png' },
    { name: 'Gord', img: 'mlbbdraftobs/Assets/HeroPick/gord.png' },
    { name: 'Granger', img: 'mlbbdraftobs/Assets/HeroPick/granger.png' },
    { name: 'Grock', img: 'mlbbdraftobs/Assets/HeroPick/grock.png' },
    { name: 'Guinevere', img: 'mlbbdraftobs/Assets/HeroPick/guinevere.png' },
    { name: 'Gusion', img: 'mlbbdraftobs/Assets/HeroPick/gusion.png' },
    { name: 'Hanabi', img: 'mlbbdraftobs/Assets/HeroPick/hanabi.png' },
    { name: 'Hanzo', img: 'mlbbdraftobs/Assets/HeroPick/hanzo.png' },
    { name: 'Harith', img: 'mlbbdraftobs/Assets/HeroPick/harith.png' },
    { name: 'Harley', img: 'mlbbdraftobs/Assets/HeroPick/harley.png' },
    { name: 'Hayabusa', img: 'mlbbdraftobs/Assets/HeroPick/hayabusa.png' },
    { name: 'Helcurt', img: 'mlbbdraftobs/Assets/HeroPick/helcurt.png' },
    { name: 'Hilda', img: 'mlbbdraftobs/Assets/HeroPick/hilda.png' },
    { name: 'Hylos', img: 'mlbbdraftobs/Assets/HeroPick/hylos.png' },
    { name: 'Irithel', img: 'mlbbdraftobs/Assets/HeroPick/irithel.png' },
    { name: 'Ixia', img: 'mlbbdraftobs/Assets/HeroPick/ixia.png' },
    { name: 'Jawhead', img: 'mlbbdraftobs/Assets/HeroPick/jawhead.png' },
    { name: 'Johnson', img: 'mlbbdraftobs/Assets/HeroPick/johnson.png' },
    { name: 'Joy', img: 'mlbbdraftobs/Assets/HeroPick/joy.png' },
    { name: 'Julian', img: 'mlbbdraftobs/Assets/HeroPick/julian.png' },
    { name: 'Kadita', img: 'mlbbdraftobs/Assets/HeroPick/kadita.png' },
    { name: 'Kagura', img: 'mlbbdraftobs/Assets/HeroPick/kagura.png' },
    { name: 'Kaja', img: 'mlbbdraftobs/Assets/HeroPick/kaja.png' },
    { name: 'Karina', img: 'mlbbdraftobs/Assets/HeroPick/karina.png' },
    { name: 'Karrie', img: 'mlbbdraftobs/Assets/HeroPick/karrie.png' },
    { name: 'Khaleed', img: 'mlbbdraftobs/Assets/HeroPick/khaleed.png' },
    { name: 'Khufra', img: 'mlbbdraftobs/Assets/HeroPick/khufra.png' },
    { name: 'Kimmy', img: 'mlbbdraftobs/Assets/HeroPick/kimmy.png' },
